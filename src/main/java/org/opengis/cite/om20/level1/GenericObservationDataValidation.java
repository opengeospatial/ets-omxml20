...
public class GenericObservationDataValidation extends DataFixture {
	...
	/**
	 * A.1 Generic observation data. Verify that any XML element in the substitution group
	 * of om:OM_Observation is well-formed and valid
	 */
	@Test(groups = "A.1. Generic observation data - by various Schema References",
			description = "Validate the XML document using the XML schema document observation.xsd")
