...
//		}
	...
	public boolean xpathToBoolean(String strXPath) {
...
//					  ClassLoader.getSystemClassLoader());
	        ...
	        Object rs= xPathExpr.evaluate(this.testSubject, XPathConstants.BOOLEAN);
	        if (rs != null)
	        {
	        	return (Boolean)rs;
	        }else{
...
//		URL schRef = this.getClass().getResource("/org/opengis/cite/om20/sch/truthObservation.sch");
//		ETSAssert.assertSchematronValid(schRef, new StreamSource(this.dataFile));
//	}
//
//	// A.6
...
//		URL schRef = this.getClass().getResource("/org/opengis/cite/om20/sch/geometryObservation.sch");
//		ETSAssert.assertSchematronValid(schRef, new StreamSource(this.dataFile));
//	}
//
//	// A.7
...
//		URL schRef = this.getClass().getResource("/org/opengis/cite/om20/sch/temporalObservation.sch");
//		ETSAssert.assertSchematronValid(schRef, new StreamSource(this.dataFile));
//	}
//
//	// A.8
...
//		URL schRef = this.getClass().getResource("/org/opengis/cite/om20/sch/complexObservation.sch");
//		ETSAssert.assertSchematronValid(schRef, new StreamSource(this.dataFile));
//	}
//
//	// A.9
...
//		URL schRef = this.getClass().getResource("/org/opengis/cite/om20/sch/SWEScalarObservation.sch");
//		ETSAssert.assertSchematronValid(schRef, new StreamSource(this.dataFile));
//	}
//
//	// A.10
...
//		URL schRef = this.getClass().getResource("/org/opengis/cite/om20/sch/SWEArrayObservation.sch");
//		ETSAssert.assertSchematronValid(schRef, new StreamSource(this.dataFile));
//	}
//
//	// A.11
...
//		URL schRef = this.getClass().getResource("/org/opengis/cite/om20/sch/spatialObservation.sch");
//		ETSAssert.assertSchematronValid(schRef, new StreamSource(this.dataFile));
//	}
//
//	// A.12
...
//		URL schRef = this.getClass().getResource("/org/opengis/cite/om20/xsd/opengis/om/2.0/samplingFeature.xsd");
//		ETSAssert.assertSchematronValid(schRef, new StreamSource(this.dataFile));
//	}
//
//	// A.13
...
//		URL schRef = this.getClass().getResource("/org/opengis/cite/om20/sch/samplingPoint.sch");
//		ETSAssert.assertSchematronValid(schRef, new StreamSource(this.dataFile));
//	}
//
//	// A.15
...
//		URL schRef = this.getClass().getResource("/org/opengis/cite/om20/sch/samplingCurve.sch");
//		ETSAssert.assertSchematronValid(schRef, new StreamSource(this.dataFile));
//	}
//
//	// A.16
...
//		URL schRef = this.getClass().getResource("/org/opengis/cite/om20/sch/samplingSurface.sch");
//		ETSAssert.assertSchematronValid(schRef, new StreamSource(this.dataFile));
//	}
//
//	// A.17
...
//		URL schRef = this.getClass().getResource("/org/opengis/cite/om20/sch/samplingSolid.sch");
//		ETSAssert.assertSchematronValid(schRef, new StreamSource(this.dataFile));
//	}
//
//	// A.18
...
//		URL schRef = this.getClass().getResource("/org/opengis/cite/om20/xsd/opengis/om/2.0/specimen.xsd");
//		ETSAssert.assertSchematronValid(schRef, new StreamSource(this.dataFile));
//	}
//
//	/**
