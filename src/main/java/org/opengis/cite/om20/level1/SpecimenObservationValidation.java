...
public class SpecimenObservationValidation extends DataFixture {
	...
	/**
	 * A.18 Specimen data. Verify that any XML element in the substitution group of
	 * spec:SF_Specimen is well-formed and valid
	 */
	@Test(groups = "A.18. Specimen data",
			description = "Validate the XML document using the XML Schema document http://schemas.opengis.net/samplingSpecimen/2.0/specimen.xsd")
